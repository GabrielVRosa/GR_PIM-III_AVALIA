...
```bash
# Clone o repositório
git clone https://github.com/IsabellaLeal06/PIM-III_AVALIA
...
Acesse a pasta [`/gr_docs`](./gr_docs/) para consultar toda a documentação técnica do projeto, incluindo:
