# 🗂️ GR_Sprint Backlog – Projeto Avalia+
...
|---------|--------|--------|
| `gr_sprint-1-backlog.md` | Sprint 1 – Estrutura Inicial | ✅ Concluída |
| `gr_sprint-2-backlog.md` | Sprint 2 – Modelagem do Sistema | ✅ Concluída |
| `gr_sprint-3-backlog.md` | Sprint 3 – Desenvolvimento das Funcionalidades | ✅ Concluída |
| `gr_sprint-4-backlog.md` | Sprint 4 – Análise e Resultados | 🔲 Em andamento |
